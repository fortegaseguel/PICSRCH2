    ...
    <>
      ...
      >
        <div className="w-full flex h-full">
          ...
          <div
            ref={textRef}
            className="text-white text-2xl w-2/4  main-text mt-[200vh] flex flex-col justify-center"
          >
            ...
            <motion.hr
              variants={width}
              animate={isTextInView ? "open" : "closed"}
              className="border border-white mb-4 md:w-[60%]"
            />
