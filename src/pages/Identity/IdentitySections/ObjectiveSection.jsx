  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#FFFFFF]">
      <div ref={sectionRef} className="h-[250vh] w-full flex flex-col items-center justify-center">
        ...
        >
          <h1 className="font-din text-6xl md:text-7xl tracking-custom mb-4 text-['darkblue']">OBJECTIVE</h1>
          <p className="font-montserrat text-sm md:text-lg mb-4 md:w-[60%]">
          Nos destacamos en logística para asegurar tu tranquilidad, <span className='font-montserrat-bold'> siendo nuestro sello distintivo. </span> Nuestra experiencia en compra, almacenamiento y entrega eficiente nos convierte en el socio ideal para tus necesidades de abastecimiento y distribución.
          </p>
