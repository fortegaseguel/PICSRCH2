...
const IdentitySection = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#0061FF]">
      <div ref={sectionRef} className="h-[250vh] w-full flex flex-col items-center justify-center">
        ...
        />
        <motion.div
          className="absolute top-[40%] left-1/2 transform -translate-x-1/2 text-white text-2xl flex flex-col items-start main-text"
          initial={{ opacity: 0, y: 300 }}
          animate={textControls}
        >
          <h1 className="font-din text-6xl md:text-7xl tracking-custom mb-4 text-['darkblue']">IDENTITY</h1>
