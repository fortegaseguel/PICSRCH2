...
const ScrollIndicator = ({ isAtSpecialSection = false, onClickAction }) => {
  ...
  return (
    <div className={isAtBottom ? "" : "opacity-delay--400"}>
      <motion.div
      ...
      >
        <div
          className={`transition ease-in-out text-xl font-medium text-white bg-[length:150%_100%] animate-pulse ${
        ...
        <div
          className={isAtBottom || isAtSpecialSection ? "rotate-[180deg] " : ""}
        >
          <motion.div
            className={`w-40 h-0.5 bg-white t$`}
